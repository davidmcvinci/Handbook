...
<body>
		...
		<div class="wholebody">
			...
			<ul class="nav_on_profile">
				...
				<div class="indicator" style="background-color: blue; width: 110px; height: 5px; border-radius: 20px; position: absolute; top: 355px; left: 56vw;  "></div>
		</div>
</body>
